                    ...
                    <div class="modal-body">
                        ...
                        <?php echo form_open('index.php/cursos/nuevo_Curso'); ?>
                            ...
                            <div class="input-group m-1 input-group-md">
                                ...
                                <input type="number" class="form-control" name="modalidad">
                            </div>
                            <div class="input-group m-1 input-group-md">
                                <div class="input-group-prepend">
                        ...
                        <div class="modal-body">
                            ...
                            <?php echo form_open('index.php/cursos/editar_Curso'); ?>
                                ...
                                <div class="input-group m-1 input-group-md">
                                    ...
                                    <input type="text" class="form-control" name="profesor"  value = "<?php echo $c_cerrados[$w]['profesor']; ?>">
                                </div>
                                <div class="input-group m-1 input-group-md">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" for="detalles">Detalles</span>
                                ...
                                <div class="input-group m-1 input-group-md">
                                    ...
                                    <input type="number" class="form-control" name="modalidad"  value = "<?php echo $c_cerrados[$w]['modalidad']; ?>">
                                </div>
                                <div class="input-group m-1 input-group-md">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" for="objetivo">Objetivo</span>
                                    </div>
                                    <input type="text" class="form-control" name="objetivo"  value = "<?php echo $c_cerrados[$w]['objetivo']; ?>">
                                </div>
                                <div class="input-group m-1 input-group-md">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" for="programa">Programa</span>
                                    </div>
                                    <input type="text" class="form-control" name="programa"  value = "<?php echo $c_cerrados[$w]['programa']; ?>">
                                </div>
                                <div class="input-group m-1 input-group-md">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" for="materiales">Materiales</span>
                                    </div>
                                    <input type="text" class="form-control" name="materiales"  value = "<?php echo $c_cerrados[$w]['materiales']; ?>">
                                </div>
                                <div class="input-group m-1 input-group-md">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" for="requisitos">Requisitos</span>
                                    </div>
                                    <input type="text" class="form-control" name="requisitos"  value = "<?php echo $c_cerrados[$w]['requisitos']; ?>">
                                </div>
                                <div class="input-group m-1 input-group-md">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" for="kit_inicio">Kit de inicio</span>
                                    </div>
                                    <input type="text" class="form-control" name="kit_inicio"  value = "<?php echo $c_cerrados[$w]['kit_inicio']; ?>">
                                </div>
                                <div class="input-group m-1 input-group-md">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" for="duracion" >Duracion</span>
                        ...
                        <div class="modal-body">
                            ...
                            <?php echo form_open('index.php/cursos/editar_Curso'); ?>
                                ...
                                <div class="input-group m-1 input-group-md">
                                    ...
                                    <input type="number" class="form-control" name="modalidad"  value = "<?php echo $c_abiertos[$w]['modalidad']; ?>">
                                </div>
                                <div class="input-group m-1 input-group-md">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" for="objetivo">Objetivo</span>
